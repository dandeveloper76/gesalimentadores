...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO formulario (nombre, phone, dni, carrer) VALUES ('$nombre', '$phone', '$dni', '$carrer')";

    if ($conn->query($sql) === TRUE) {
        // Redirige a la página mostrar_datos.php con los datos en la URL
        header("Location: docu.php?nombre=$nombre&phone=$phone&dni=$dni&carrer=$carrer");
        exit();
    } else {
