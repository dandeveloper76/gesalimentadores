...
<div class="row">
 <div class="col-md-6">					
  ...
  <form action="procesar.php" method="POST">
    ...
    <input class="form-control" type="text" name="carrer" id="carrer" required>
	</div>
    <br>
	<div class="form-group">
	<label for="mascota">Nom mascota:</label>
    <input class="form-control" type="text" name="mascota" id="mascota" required>
	</div>
    <br>
	<div class="form-group">
	<label for="edad">Espècie:</label>
    ...
    <br>
	<div class="form-group">
	<label for="rasa">Raça:</label>
    <input class="form-control" type="text" name="rasa" id="rasa" required>
	</div>
    <br>
	<div class="form-group">
	<label for="naixement">Data naixement:</label>
    <input class="form-control" type="text" name="naixement" id="naixement" required>
	</div>
    <br>
  ...
  <div class="col-md-6">
   <img src="img/avatars/adopta.jpg" width="100%"/> 
  </div>
 </div>
 </div>
				</div>
